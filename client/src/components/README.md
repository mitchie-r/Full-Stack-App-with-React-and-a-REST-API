This is a full stack app with React and a REST API. The program is separated into the API folder and client folder and both have separate overall functions.
